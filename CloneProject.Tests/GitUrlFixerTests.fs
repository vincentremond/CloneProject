...
module GitUrlFixerTests =
    ...
    [<Test>]
    [<TestCase("https://xxxx@dev.azure.com/yyy/xxx/_git/lorem",
               ExpectedResult = "https://dev.azure.com/yyy/xxx/_git/lorem")>]
    ...
    [<TestCase("https://github.com/vincentremond/Pinicola.FSharp.git",
               ExpectedResult = "https://github.com/vincentremond/Pinicola.FSharp.git")>]
